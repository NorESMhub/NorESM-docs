...
The NorESM2.1 release (NorESM tag **release-noresm2.1.1**) is a technical release that includes a few bug fixes along with numerous code improvements from the NorESM2.0 release (NorESM tag **release-noresm2.0.6**).
